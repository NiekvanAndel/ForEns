 ...
 *
 * Rainfall alone. Temperature and wind have a spread too, and adding them would
 * double the response for a figure no widget currently draws.
 */
...
export async function fetchEnsembleOutlook(
  ...
  const url =
    ...
    `&daily=precipitation_sum&models=ecmwf_ifs025&forecast_days=${ENSEMBLE_OUTLOOK_DAYS}`;
