 ...
 *
 * It is a radio, not a set of switches. Both layers paint precipitation over the same
 * ground in two different colour ramps, and a reader who could turn both on would get
 * a picture in which neither ramp means anything. Which one is showing is therefore a
 * choice between them, and the button fills in while anything but the default is on —
 * so a reader who left the totals up and came back knows why the map looks different.
 *
...
export type MapLayer = 'nowcast' | 'cumulative';
