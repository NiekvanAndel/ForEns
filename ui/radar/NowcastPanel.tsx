...
export function NowcastPanel({ profile, offsetMin, width }: NowcastPanelProps) {
    ...
    <View style={{ paddingHorizontal: space[5], paddingTop: space[4], paddingBottom: space[3] }}>
      <View style={{ flexDirection: 'row', alignItems: 'flex-start' }}>
        <View>
          ...
          <Text variant="screenTitle" color={palette.inkHeading} tabular>
            {clockAt(offsetMin)}
          </Text>
        </View>
      ...
      <Svg width={width} height={HEIGHT} style={{ marginTop: space[3] }}>
        <Defs>
